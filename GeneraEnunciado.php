...
<body>
    ...
    // Ejemplo de llamada a la función "genera_algo"
    $texto_generado = genera_algo("Enunciado de problema matemático con números aleatorios que involucra sumas, restas, multiplicaciones y divisiones exactas");
    //genera_algo("Enunciado de matemáticas con números aleatorios en el que haya que hacer sumas y restas de enteros con multiplicaciones y divisiones exactas. El resulado puede ser positivo o negativo. El json generado debe ser de la forma {enuncidado:, respuesta:");
